...
**[XML Inspector](https://github.com/andykear/FileMaker-XML-inspector-open-source)** (SaXML) — this repo
Full catalog dependency analysis of a Save as XML export, entirely in the browser. Finds unreferenced fields, silent failure risks, broken references, Anchor–Buoy severing candidates with work plans, and diffs two versions of a solution against each other.
