...
Load a FileMaker DDR XML file (exported via Save a Copy as XML) and the Inspector parses it entirely in your browser. Nothing is uploaded anywhere.
...
For generating pasteable FileMaker script XML, see the companion [FileMaker XML Skill](https://github.com/clockworkcreative/filemaker-xml-skill) repo.
